...
#define GPH1CON				(ELFIN_GPIO_BASE+GPH2CON_OFFSET)
#define GPH1DAT				(ELFIN_GPIO_BASE+GPH2DAT_OFFSET)
#define GPH1PUD				(ELFIN_GPIO_BASE+GPH2PUD_OFFSET)
#define GPH1DRV				(ELFIN_GPIO_BASE+GPH2DRV_OFFSET)
